...
(function(root, factory) {
  ...
  describe('ConvertImageApi', function() {
    ...
    describe('convertImageMultipageImageFormatConvert', function() {
      it('should call convertImageMultipageImageFormatConvert successfully', function(done) {
        //uncomment below and update the code to test convertImageMultipageImageFormatConvert
        //instance.convertImageMultipageImageFormatConvert(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
