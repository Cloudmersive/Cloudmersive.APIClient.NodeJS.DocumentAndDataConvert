...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetXlsxCellRequest();
  });
  ...
  describe('GetXlsxCellRequest', function() {
    it('should create an instance of GetXlsxCellRequest', function() {
      // uncomment below and update the code to test GetXlsxCellRequest
      //var instance = new CloudmersiveConvertApiClient.GetXlsxCellRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetXlsxCellRequest);
    });
