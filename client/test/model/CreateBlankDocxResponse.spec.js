...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.CreateBlankDocxResponse();
  });
  ...
  describe('CreateBlankDocxResponse', function() {
    it('should create an instance of CreateBlankDocxResponse', function() {
      // uncomment below and update the code to test CreateBlankDocxResponse
      //var instance = new CloudmersiveConvertApiClient.CreateBlankDocxResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.CreateBlankDocxResponse);
    });
