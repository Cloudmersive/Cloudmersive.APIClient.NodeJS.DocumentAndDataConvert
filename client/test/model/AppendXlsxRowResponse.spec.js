...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.AppendXlsxRowResponse();
  });
  ...
  describe('AppendXlsxRowResponse', function() {
    it('should create an instance of AppendXlsxRowResponse', function() {
      // uncomment below and update the code to test AppendXlsxRowResponse
      //var instance = new CloudmersiveConvertApiClient.AppendXlsxRowResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.AppendXlsxRowResponse);
    });
