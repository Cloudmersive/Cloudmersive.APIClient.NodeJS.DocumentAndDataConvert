...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetXlsxStylesRequest();
  });
  ...
  describe('GetXlsxStylesRequest', function() {
    it('should create an instance of GetXlsxStylesRequest', function() {
      // uncomment below and update the code to test GetXlsxStylesRequest
      //var instance = new CloudmersiveConvertApiClient.GetXlsxStylesRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetXlsxStylesRequest);
    });
