...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.SetPdfFormFieldsRequest();
  });
  ...
  describe('SetPdfFormFieldsRequest', function() {
    it('should create an instance of SetPdfFormFieldsRequest', function() {
      // uncomment below and update the code to test SetPdfFormFieldsRequest
      //var instance = new CloudmersiveConvertApiClient.SetPdfFormFieldsRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.SetPdfFormFieldsRequest);
    });
