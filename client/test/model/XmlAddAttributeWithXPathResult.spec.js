...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.XmlAddAttributeWithXPathResult();
  });
  ...
  describe('XmlAddAttributeWithXPathResult', function() {
    it('should create an instance of XmlAddAttributeWithXPathResult', function() {
      // uncomment below and update the code to test XmlAddAttributeWithXPathResult
      //var instance = new CloudmersiveConvertApiClient.XmlAddAttributeWithXPathResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.XmlAddAttributeWithXPathResult);
    });
