...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.PdfDocument();
  });
  ...
  describe('PdfDocument', function() {
    it('should create an instance of PdfDocument', function() {
      ...
      //var instance = new CloudmersiveConvertApiClient.PdfDocument();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.PdfDocument);
    });
