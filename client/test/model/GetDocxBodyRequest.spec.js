...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetDocxBodyRequest();
  });
  ...
  describe('GetDocxBodyRequest', function() {
    it('should create an instance of GetDocxBodyRequest', function() {
      // uncomment below and update the code to test GetDocxBodyRequest
      //var instance = new CloudmersiveConvertApiClient.GetDocxBodyRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetDocxBodyRequest);
    });
