...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.DocxInsertImageResponse();
  });
  ...
  describe('DocxInsertImageResponse', function() {
    it('should create an instance of DocxInsertImageResponse', function() {
      // uncomment below and update the code to test DocxInsertImageResponse
      //var instance = new CloudmersiveConvertApiClient.DocxInsertImageResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.DocxInsertImageResponse);
    });
