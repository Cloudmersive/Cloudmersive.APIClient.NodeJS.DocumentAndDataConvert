...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.SetXlsxCellRequest();
  });
  ...
  describe('SetXlsxCellRequest', function() {
    it('should create an instance of SetXlsxCellRequest', function() {
      // uncomment below and update the code to test SetXlsxCellRequest
      //var instance = new CloudmersiveConvertApiClient.SetXlsxCellRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.SetXlsxCellRequest);
    });
