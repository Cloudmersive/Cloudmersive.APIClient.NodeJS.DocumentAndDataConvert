...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.HtmlGetLanguageResult();
  });
  ...
  describe('HtmlGetLanguageResult', function() {
    it('should create an instance of HtmlGetLanguageResult', function() {
      // uncomment below and update the code to test HtmlGetLanguageResult
      //var instance = new CloudmersiveConvertApiClient.HtmlGetLanguageResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.HtmlGetLanguageResult);
    });
