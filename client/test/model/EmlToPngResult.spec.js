...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.EmlToPngResult();
  });
  ...
  describe('EmlToPngResult', function() {
    it('should create an instance of EmlToPngResult', function() {
      // uncomment below and update the code to test EmlToPngResult
      //var instance = new CloudmersiveConvertApiClient.EmlToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.EmlToPngResult);
    });
