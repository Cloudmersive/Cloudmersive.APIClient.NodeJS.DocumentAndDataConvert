...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.SetXlsxCellByIdentifierRequest();
  });
  ...
  describe('SetXlsxCellByIdentifierRequest', function() {
    it('should create an instance of SetXlsxCellByIdentifierRequest', function() {
      // uncomment below and update the code to test SetXlsxCellByIdentifierRequest
      //var instance = new CloudmersiveConvertApiClient.SetXlsxCellByIdentifierRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.SetXlsxCellByIdentifierRequest);
    });
