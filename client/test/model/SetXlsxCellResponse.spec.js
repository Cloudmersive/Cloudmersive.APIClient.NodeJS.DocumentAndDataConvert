...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.SetXlsxCellResponse();
  });
  ...
  describe('SetXlsxCellResponse', function() {
    it('should create an instance of SetXlsxCellResponse', function() {
      // uncomment below and update the code to test SetXlsxCellResponse
      //var instance = new CloudmersiveConvertApiClient.SetXlsxCellResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.SetXlsxCellResponse);
    });
