...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.OdsToPngResult();
  });
  ...
  describe('OdsToPngResult', function() {
    it('should create an instance of OdsToPngResult', function() {
      // uncomment below and update the code to test OdsToPngResult
      //var instance = new CloudmersiveConvertApiClient.OdsToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.OdsToPngResult);
    });
