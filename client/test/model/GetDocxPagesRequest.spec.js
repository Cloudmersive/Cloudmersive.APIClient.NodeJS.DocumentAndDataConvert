...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetDocxPagesRequest();
  });
  ...
  describe('GetDocxPagesRequest', function() {
    it('should create an instance of GetDocxPagesRequest', function() {
      // uncomment below and update the code to test GetDocxPagesRequest
      //var instance = new CloudmersiveConvertApiClient.GetDocxPagesRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetDocxPagesRequest);
    });
