...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetDocxSectionsRequest();
  });
  ...
  describe('GetDocxSectionsRequest', function() {
    it('should create an instance of GetDocxSectionsRequest', function() {
      // uncomment below and update the code to test GetDocxSectionsRequest
      //var instance = new CloudmersiveConvertApiClient.GetDocxSectionsRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetDocxSectionsRequest);
    });
