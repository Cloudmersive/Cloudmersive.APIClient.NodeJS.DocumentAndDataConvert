...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.ClearXlsxRowRequest();
  });
  ...
  describe('ClearXlsxRowRequest', function() {
    it('should create an instance of ClearXlsxRowRequest', function() {
      // uncomment below and update the code to test ClearXlsxRowRequest
      //var instance = new CloudmersiveConvertApiClient.ClearXlsxRowRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.ClearXlsxRowRequest);
    });
    ...
    it('should have the property worksheetToEdit (base name: "WorksheetToEdit")', function() {
      // uncomment below and update the code to test the property worksheetToEdit
      //var instance = new CloudmersiveConvertApiClient.ClearXlsxRowRequest();
      //expect(instance).to.be();
    });
