...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.AlternateFileFormatCandidate();
  });
  ...
  describe('AlternateFileFormatCandidate', function() {
    it('should create an instance of AlternateFileFormatCandidate', function() {
      // uncomment below and update the code to test AlternateFileFormatCandidate
      //var instance = new CloudmersiveConvertApiClient.AlternateFileFormatCandidate();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.AlternateFileFormatCandidate);
    });
