...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.KeynoteToPngResult();
  });
  ...
  describe('KeynoteToPngResult', function() {
    it('should create an instance of KeynoteToPngResult', function() {
      // uncomment below and update the code to test KeynoteToPngResult
      //var instance = new CloudmersiveConvertApiClient.KeynoteToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.KeynoteToPngResult);
    });
