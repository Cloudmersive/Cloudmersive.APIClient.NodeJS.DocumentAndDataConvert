...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.AppendXlsxRowRequest();
  });
  ...
  describe('AppendXlsxRowRequest', function() {
    it('should create an instance of AppendXlsxRowRequest', function() {
      // uncomment below and update the code to test AppendXlsxRowRequest
      //var instance = new CloudmersiveConvertApiClient.AppendXlsxRowRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.AppendXlsxRowRequest);
    });
