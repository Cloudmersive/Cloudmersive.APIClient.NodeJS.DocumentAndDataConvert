...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.UpdateDocxTableCellRequest();
  });
  ...
  describe('UpdateDocxTableCellRequest', function() {
    it('should create an instance of UpdateDocxTableCellRequest', function() {
      // uncomment below and update the code to test UpdateDocxTableCellRequest
      //var instance = new CloudmersiveConvertApiClient.UpdateDocxTableCellRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.UpdateDocxTableCellRequest);
    });
    ...
    it('should have the property cellToUpdate (base name: "CellToUpdate")', function() {
      // uncomment below and update the code to test the property cellToUpdate
      //var instance = new CloudmersiveConvertApiClient.UpdateDocxTableCellRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tableCellIndex (base name: "TableCellIndex")', function() {
      // uncomment below and update the code to test the property tableCellIndex
      //var instance = new CloudmersiveConvertApiClient.UpdateDocxTableCellRequest();
      //expect(instance).to.be();
    });
