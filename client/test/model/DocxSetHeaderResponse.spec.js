...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.DocxSetHeaderResponse();
  });
  ...
  describe('DocxSetHeaderResponse', function() {
    it('should create an instance of DocxSetHeaderResponse', function() {
      // uncomment below and update the code to test DocxSetHeaderResponse
      //var instance = new CloudmersiveConvertApiClient.DocxSetHeaderResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.DocxSetHeaderResponse);
    });
