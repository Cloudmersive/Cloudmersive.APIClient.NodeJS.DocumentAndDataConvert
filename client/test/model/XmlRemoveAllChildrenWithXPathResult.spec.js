...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.XmlRemoveAllChildrenWithXPathResult();
  });
  ...
  describe('XmlRemoveAllChildrenWithXPathResult', function() {
    it('should create an instance of XmlRemoveAllChildrenWithXPathResult', function() {
      // uncomment below and update the code to test XmlRemoveAllChildrenWithXPathResult
      //var instance = new CloudmersiveConvertApiClient.XmlRemoveAllChildrenWithXPathResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.XmlRemoveAllChildrenWithXPathResult);
    });
