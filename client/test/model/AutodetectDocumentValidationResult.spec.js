...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.AutodetectDocumentValidationResult();
  });
  ...
  describe('AutodetectDocumentValidationResult', function() {
    it('should create an instance of AutodetectDocumentValidationResult', function() {
      // uncomment below and update the code to test AutodetectDocumentValidationResult
      //var instance = new CloudmersiveConvertApiClient.AutodetectDocumentValidationResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.AutodetectDocumentValidationResult);
    });

    it('should have the property fileFormatExtension (base name: "FileFormatExtension")', function() {
      // uncomment below and update the code to test the property fileFormatExtension
      //var instance = new CloudmersiveConvertApiClient.AutodetectDocumentValidationResult();
