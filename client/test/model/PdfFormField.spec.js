...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.PdfFormField();
  });
  ...
  describe('PdfFormField', function() {
    it('should create an instance of PdfFormField', function() {
      // uncomment below and update the code to test PdfFormField
      //var instance = new CloudmersiveConvertApiClient.PdfFormField();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.PdfFormField);
    });
    ...
    it('should have the property fieldComboBoxSelectedIndex (base name: "FieldComboBoxSelectedIndex")', function() {
      // uncomment below and update the code to test the property fieldComboBoxSelectedIndex
      //var instance = new CloudmersiveConvertApiClient.PdfFormField();
      //expect(instance).to.be();
    });
