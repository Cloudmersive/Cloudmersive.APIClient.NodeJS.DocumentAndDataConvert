...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.OdpToPngResult();
  });
  ...
  describe('OdpToPngResult', function() {
    it('should create an instance of OdpToPngResult', function() {
      // uncomment below and update the code to test OdpToPngResult
      //var instance = new CloudmersiveConvertApiClient.OdpToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.OdpToPngResult);
    });
