...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.AutodetectToPngResult();
  });
  ...
  describe('AutodetectToPngResult', function() {
    it('should create an instance of AutodetectToPngResult', function() {
      // uncomment below and update the code to test AutodetectToPngResult
      //var instance = new CloudmersiveConvertApiClient.AutodetectToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.AutodetectToPngResult);
    });
