...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetDocxStylesRequest();
  });
  ...
  describe('GetDocxStylesRequest', function() {
    it('should create an instance of GetDocxStylesRequest', function() {
      // uncomment below and update the code to test GetDocxStylesRequest
      //var instance = new CloudmersiveConvertApiClient.GetDocxStylesRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetDocxStylesRequest);
    });
