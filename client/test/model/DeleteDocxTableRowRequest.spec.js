...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.DeleteDocxTableRowRequest();
  });
  ...
  describe('DeleteDocxTableRowRequest', function() {
    it('should create an instance of DeleteDocxTableRowRequest', function() {
      // uncomment below and update the code to test DeleteDocxTableRowRequest
      //var instance = new CloudmersiveConvertApiClient.DeleteDocxTableRowRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.DeleteDocxTableRowRequest);
    });
