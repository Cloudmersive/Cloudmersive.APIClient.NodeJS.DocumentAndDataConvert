...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.PptxToPngResult();
  });
  ...
  describe('PptxToPngResult', function() {
    it('should create an instance of PptxToPngResult', function() {
      // uncomment below and update the code to test PptxToPngResult
      //var instance = new CloudmersiveConvertApiClient.PptxToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.PptxToPngResult);
    });
