...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetXlsxWorksheetsRequest();
  });
  ...
  describe('GetXlsxWorksheetsRequest', function() {
    it('should create an instance of GetXlsxWorksheetsRequest', function() {
      // uncomment below and update the code to test GetXlsxWorksheetsRequest
      //var instance = new CloudmersiveConvertApiClient.GetXlsxWorksheetsRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetXlsxWorksheetsRequest);
    });
