...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.DocxToPngResult();
  });
  ...
  describe('DocxToPngResult', function() {
    it('should create an instance of DocxToPngResult', function() {
      // uncomment below and update the code to test DocxToPngResult
      //var instance = new CloudmersiveConvertApiClient.DocxToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.DocxToPngResult);
    });
