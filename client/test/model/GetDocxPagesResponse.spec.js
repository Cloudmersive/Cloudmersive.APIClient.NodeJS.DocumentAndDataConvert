...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetDocxPagesResponse();
  });
  ...
  describe('GetDocxPagesResponse', function() {
    it('should create an instance of GetDocxPagesResponse', function() {
      // uncomment below and update the code to test GetDocxPagesResponse
      //var instance = new CloudmersiveConvertApiClient.GetDocxPagesResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetDocxPagesResponse);
    });
