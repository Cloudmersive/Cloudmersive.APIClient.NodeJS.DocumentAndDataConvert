...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.HtmlMdResult();
  });
  ...
  describe('HtmlMdResult', function() {
    it('should create an instance of HtmlMdResult', function() {
      // uncomment below and update the code to test HtmlMdResult
      //var instance = new CloudmersiveConvertApiClient.HtmlMdResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.HtmlMdResult);
    });
