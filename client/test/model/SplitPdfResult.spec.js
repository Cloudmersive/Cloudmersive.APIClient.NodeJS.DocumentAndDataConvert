...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.SplitPdfResult();
  });
  ...
  describe('SplitPdfResult', function() {
    it('should create an instance of SplitPdfResult', function() {
      // uncomment below and update the code to test SplitPdfResult
      //var instance = new CloudmersiveConvertApiClient.SplitPdfResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.SplitPdfResult);
    });
