...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.XmlAddChildWithXPathResult();
  });
  ...
  describe('XmlAddChildWithXPathResult', function() {
    it('should create an instance of XmlAddChildWithXPathResult', function() {
      // uncomment below and update the code to test XmlAddChildWithXPathResult
      //var instance = new CloudmersiveConvertApiClient.XmlAddChildWithXPathResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.XmlAddChildWithXPathResult);
    });
