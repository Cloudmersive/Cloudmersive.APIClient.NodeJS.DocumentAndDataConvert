...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.ClearXlsxRowResponse();
  });
  ...
  describe('ClearXlsxRowResponse', function() {
    it('should create an instance of ClearXlsxRowResponse', function() {
      // uncomment below and update the code to test ClearXlsxRowResponse
      //var instance = new CloudmersiveConvertApiClient.ClearXlsxRowResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.ClearXlsxRowResponse);
    });
