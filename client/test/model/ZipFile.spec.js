...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.ZipFile();
  });
  ...
  describe('ZipFile', function() {
    it('should create an instance of ZipFile', function() {
      // uncomment below and update the code to test ZipFile
      //var instance = new CloudmersiveConvertApiClient.ZipFile();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.ZipFile);
    });
