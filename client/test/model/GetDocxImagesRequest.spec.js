...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetDocxImagesRequest();
  });
  ...
  describe('GetDocxImagesRequest', function() {
    it('should create an instance of GetDocxImagesRequest', function() {
      // uncomment below and update the code to test GetDocxImagesRequest
      //var instance = new CloudmersiveConvertApiClient.GetDocxImagesRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetDocxImagesRequest);
    });
