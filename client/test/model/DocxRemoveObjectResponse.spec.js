...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.DocxRemoveObjectResponse();
  });
  ...
  describe('DocxRemoveObjectResponse', function() {
    it('should create an instance of DocxRemoveObjectResponse', function() {
      // uncomment below and update the code to test DocxRemoveObjectResponse
      //var instance = new CloudmersiveConvertApiClient.DocxRemoveObjectResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.DocxRemoveObjectResponse);
    });
