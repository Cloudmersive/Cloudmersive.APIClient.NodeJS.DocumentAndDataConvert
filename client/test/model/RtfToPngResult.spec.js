...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.RtfToPngResult();
  });
  ...
  describe('RtfToPngResult', function() {
    it('should create an instance of RtfToPngResult', function() {
      // uncomment below and update the code to test RtfToPngResult
      //var instance = new CloudmersiveConvertApiClient.RtfToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.RtfToPngResult);
    });
