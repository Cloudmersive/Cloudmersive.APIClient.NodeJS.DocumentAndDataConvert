...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetDocxTablesRequest();
  });
  ...
  describe('GetDocxTablesRequest', function() {
    it('should create an instance of GetDocxTablesRequest', function() {
      // uncomment below and update the code to test GetDocxTablesRequest
      //var instance = new CloudmersiveConvertApiClient.GetDocxTablesRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetDocxTablesRequest);
    });
