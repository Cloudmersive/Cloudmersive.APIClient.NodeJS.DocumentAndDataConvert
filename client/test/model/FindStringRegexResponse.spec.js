...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.FindStringRegexResponse();
  });
  ...
  describe('FindStringRegexResponse', function() {
    it('should create an instance of FindStringRegexResponse', function() {
      // uncomment below and update the code to test FindStringRegexResponse
      //var instance = new CloudmersiveConvertApiClient.FindStringRegexResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.FindStringRegexResponse);
    });
