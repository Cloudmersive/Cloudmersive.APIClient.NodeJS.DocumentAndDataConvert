...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.EmlToHtmlResult();
  });
  ...
  describe('EmlToHtmlResult', function() {
    it('should create an instance of EmlToHtmlResult', function() {
      // uncomment below and update the code to test EmlToHtmlResult
      //var instance = new CloudmersiveConvertApiClient.EmlToHtmlResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.EmlToHtmlResult);
    });
