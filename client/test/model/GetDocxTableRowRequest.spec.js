...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetDocxTableRowRequest();
  });
  ...
  describe('GetDocxTableRowRequest', function() {
    it('should create an instance of GetDocxTableRowRequest', function() {
      // uncomment below and update the code to test GetDocxTableRowRequest
      //var instance = new CloudmersiveConvertApiClient.GetDocxTableRowRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetDocxTableRowRequest);
    });
