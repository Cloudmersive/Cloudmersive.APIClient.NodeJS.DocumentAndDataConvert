...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.FindStringSimpleResponse();
  });
  ...
  describe('FindStringSimpleResponse', function() {
    it('should create an instance of FindStringSimpleResponse', function() {
      // uncomment below and update the code to test FindStringSimpleResponse
      //var instance = new CloudmersiveConvertApiClient.FindStringSimpleResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.FindStringSimpleResponse);
    });
