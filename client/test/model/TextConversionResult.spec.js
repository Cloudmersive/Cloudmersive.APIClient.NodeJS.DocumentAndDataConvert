...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.TextConversionResult();
  });
  ...
  describe('TextConversionResult', function() {
    it('should create an instance of TextConversionResult', function() {
      // uncomment below and update the code to test TextConversionResult
      //var instance = new CloudmersiveConvertApiClient.TextConversionResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.TextConversionResult);
    });
