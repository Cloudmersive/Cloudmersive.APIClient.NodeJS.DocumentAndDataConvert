...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.XlsxToPngResult();
  });
  ...
  describe('XlsxToPngResult', function() {
    it('should create an instance of XlsxToPngResult', function() {
      // uncomment below and update the code to test XlsxToPngResult
      //var instance = new CloudmersiveConvertApiClient.XlsxToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.XlsxToPngResult);
    });
