...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.Thumbnail();
  });
  ...
  describe('Thumbnail', function() {
    it('should create an instance of Thumbnail', function() {
      ...
      //var instance = new CloudmersiveConvertApiClient.Thumbnail();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.Thumbnail);
    });
