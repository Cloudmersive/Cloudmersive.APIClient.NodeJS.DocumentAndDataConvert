...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.XmlSetValueWithXPathResult();
  });
  ...
  describe('XmlSetValueWithXPathResult', function() {
    it('should create an instance of XmlSetValueWithXPathResult', function() {
      // uncomment below and update the code to test XmlSetValueWithXPathResult
      //var instance = new CloudmersiveConvertApiClient.XmlSetValueWithXPathResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.XmlSetValueWithXPathResult);
    });
