...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.InsertDocxInsertParagraphRequest();
  });
  ...
  describe('InsertDocxInsertParagraphRequest', function() {
    it('should create an instance of InsertDocxInsertParagraphRequest', function() {
      // uncomment below and update the code to test InsertDocxInsertParagraphRequest
      //var instance = new CloudmersiveConvertApiClient.InsertDocxInsertParagraphRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.InsertDocxInsertParagraphRequest);
    });
    ...
    it('should have the property paragraphToInsert (base name: "ParagraphToInsert")', function() {
      // uncomment below and update the code to test the property paragraphToInsert
      //var instance = new CloudmersiveConvertApiClient.InsertDocxInsertParagraphRequest();
      //expect(instance).to.be();
    });
