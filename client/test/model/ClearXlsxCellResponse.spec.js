...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.ClearXlsxCellResponse();
  });
  ...
  describe('ClearXlsxCellResponse', function() {
    it('should create an instance of ClearXlsxCellResponse', function() {
      // uncomment below and update the code to test ClearXlsxCellResponse
      //var instance = new CloudmersiveConvertApiClient.ClearXlsxCellResponse();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.ClearXlsxCellResponse);
    });
