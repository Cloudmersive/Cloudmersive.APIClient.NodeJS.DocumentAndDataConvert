...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.OdtToPngResult();
  });
  ...
  describe('OdtToPngResult', function() {
    it('should create an instance of OdtToPngResult', function() {
      // uncomment below and update the code to test OdtToPngResult
      //var instance = new CloudmersiveConvertApiClient.OdtToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.OdtToPngResult);
    });
