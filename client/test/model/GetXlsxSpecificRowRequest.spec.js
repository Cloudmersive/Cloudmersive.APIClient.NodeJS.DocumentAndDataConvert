...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.GetXlsxSpecificRowRequest();
  });
  ...
  describe('GetXlsxSpecificRowRequest', function() {
    it('should create an instance of GetXlsxSpecificRowRequest', function() {
      // uncomment below and update the code to test GetXlsxSpecificRowRequest
      //var instance = new CloudmersiveConvertApiClient.GetXlsxSpecificRowRequest();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.GetXlsxSpecificRowRequest);
    });
