...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.MsgToPngResult();
  });
  ...
  describe('MsgToPngResult', function() {
    it('should create an instance of MsgToPngResult', function() {
      // uncomment below and update the code to test MsgToPngResult
      //var instance = new CloudmersiveConvertApiClient.MsgToPngResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.MsgToPngResult);
    });
