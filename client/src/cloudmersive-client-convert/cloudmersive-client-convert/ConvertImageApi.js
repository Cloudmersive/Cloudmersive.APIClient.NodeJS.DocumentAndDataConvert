...
(function(root, factory) {
   ...
   * @module cloudmersive-client-convert/cloudmersive-client-convert/ConvertImageApi
   * @version 1.0.6
   */

  /**
   * Constructs a new ConvertImageApi. 
   * @alias module:cloudmersive-client-convert/cloudmersive-client-convert/ConvertImageApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloudmersive-client-convert/cloudmersive-client-convert/ConvertImageApi~convertImageImageFormatConvertCallback
     ...
     * @param {module:cloudmersive-client-convert/cloudmersive-client-convert/ConvertImageApi~convertImageImageFormatConvertCallback} callback The callback function, accepting three arguments: error, data, response
