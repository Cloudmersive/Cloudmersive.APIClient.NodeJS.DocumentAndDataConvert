...
(function(root, factory) {
   ...
   * @module cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi
   * @version 1.0.3
   */

  /**
   * Constructs a new ConvertDocumentApi. 
   * @alias module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentAutodetectToPdfCallback
     ...
     * @param {module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentAutodetectToPdfCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentDocxToPdfCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentDocxToPdfCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
     ...
     * @callback module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentPptxToPdfCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentPptxToPdfCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
     ...
     * @callback module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentXlsxToCsvCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentXlsxToCsvCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
     ...
     * @callback module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentXlsxToPdfCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:cloudmersive.client.convert.invoke/cloudmersive.client.convert.api/ConvertDocumentApi~convertDocumentXlsxToPdfCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
